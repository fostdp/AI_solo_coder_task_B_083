...
class Config:
    ...
    efficacy_engine: Dict[str, Any] = field(default_factory=dict)
    text_miner: Dict[str, Any] = field(default_factory=dict)
    comparator: Dict[str, Any] = field(default_factory=dict)
    spread_engine: Dict[str, Any] = field(default_factory=dict)
    ...
    def _apply_config(self, config_data: Dict[str, Any]) -> None:
        ...
        self.efficacy_engine = config_data.get("efficacy_engine", {})
        self.text_miner = config_data.get("text_miner", {})
        self.comparator = config_data.get("comparator", {})
        self.spread_engine = config_data.get("spread_engine", {})
